<?php
function astoryofgrace_form_system_theme_settings_alter(&$form, &$form_state) {
 ...
 $form['background_container']['body_bg_classes'] = array(
  ...
  $form['#submit'][] = 'astoryofgrace_settings_submit';
  $form['#validate'][] = 'astoryofgrace_settings_validate';
}

function astoryofgrace_settings_submit($form, &$form_state) {
  $settings = array();
...
function astoryofgrace_settings_validate($form, &$form_state) {
